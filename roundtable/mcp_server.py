...
for _fn in (
    ...
    core.roundtable_bind_diff,
    core.roundtable_repo_context,
    core.roundtable_repo_pack,
    core.roundtable_set_context,
    core.roundtable_bind_context,
    core.roundtable_context,
    core.roundtable_converge,
    core.roundtable_compact,
