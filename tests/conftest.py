...
os.environ.setdefault("CLAUDE_HOME", os.path.join(_TEST_TMP, "claude-home"))
os.environ.setdefault("CLAUDE_WEB_STATE_DIR", os.path.join(_TEST_TMP, "claude-web-state"))
os.environ.setdefault("CLAUDE_PROJECT_DIR", os.path.join(_TEST_TMP, "project"))
os.environ.setdefault("CLAUDE_WEB_ENABLE_SETUP", "true")
